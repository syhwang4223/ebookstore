...
insert into book (title, author, price, isbn, publication_date, publisher, img_url, category_id, likes)
    values ('돌아와', '하하이', 5000, '9915264626321', '2011-04-12', '우와', null, 1, 0);
insert into book (title, author, price, isbn, publication_date, publisher, img_url, category_id, likes)
...
insert into book (title, author, price, isbn, publication_date, publisher, img_url, category_id, likes)
    values ('하류 생활', '홍홍이', 17000, '1451756246248', '2014-03-07', '뿌리', null, 2, 0);
insert into book (title, author, price, isbn, publication_date, publisher, img_url, category_id, likes)
    values ('엄마가 된 S급 헌터', 'SY', 13400, '2883283604341', '2015-01-24', '맥시', null, 2, 0);
insert into book (title, author, price, isbn, publication_date, publisher, img_url, category_id, likes)
    values ('병약한 공녀의 요양일기', '진혜', 24500, '5681284116521', '2020-01-12', '광팬', null, 2, 0);
insert into book (title, author, price, isbn, publication_date, publisher, img_url, category_id, likes)
    values ('이제 그만하고 싶어!', '일만수', 18200, '5421713506356', '2015-05-06', '광팬', null, 2, 0);
-- 판타지
insert into book (title, author, price, isbn, publication_date, publisher, img_url, category_id, likes)
    values ('전지적 작가 시점', '샹숑', 91000, '6421653206321', '2017-06-22', '판타지수첩', null, 3, 0);
insert into book (title, author, price, isbn, publication_date, publisher, img_url, category_id, likes)
    values ('환생 폭군은 죽고 싶어', '팔팍', 18200, '1151756246248', '2015-08-11', '러시브', null, 3, 0);
insert into book (title, author, price, isbn, publication_date, publisher, img_url, category_id, likes)
    values ('택배 실종 사건', '마치', 82100, '4581243106411', '2008-01-24', '판타지수첩', null, 3, 0);
insert into book (title, author, price, isbn, publication_date, publisher, img_url, category_id, likes)
    values ('이세계에서 힐러로 살아남기', '두리루', 17200, '1825786106321', '2013-02-15', '도어락', null, 3, 0);
insert into book (title, author, price, isbn, publication_date, publisher, img_url, category_id, likes)
    values ('힘을 숨긴  XX', '립스피', 34100, '1581584102325', '2012-05-11', '도어락', null, 3, 0);
-- bl
insert into book (title, author, price, isbn, publication_date, publisher, img_url, category_id, likes)
    values ('저 퇴근하고 싶어요', '미커', 17200, '4281583126321', '2022-04-22', '블레스', null, 4, 0);
insert into book (title, author, price, isbn, publication_date, publisher, img_url, category_id, likes)
    values ('5월의 신랑', '별다랑', 90400, '2385763706221', '2012-08-09', '블루투스', null, 4, 0);
insert into book (title, author, price, isbn, publication_date, publisher, img_url, category_id, likes)
    values ('체크 메이트', '들쥐', 12700, '4851283105672', '2005-01-22', '립스틱', null, 4, 0);
insert into book (title, author, price, isbn, publication_date, publisher, img_url, category_id, likes)
